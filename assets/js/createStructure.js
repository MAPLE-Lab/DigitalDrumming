...
$(document).ready(function() {
    ...
    $('#comparisonDisplay').append(
        '<div id="slot1" class="mainslot activeSlot">' +
        '   <div id="datumExample1" class="datumExample"></div>' +
        ...
        '</div>' +
        '<div id="slot2" class="mainslot">' +
        '   <div id="datumExample2" class="datumExample"></div>' +
